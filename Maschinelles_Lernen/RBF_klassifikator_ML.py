# -*- coding: utf-8 -*-
"""
@author: Dimitri Sonkwa und Donald Yamegueu
"""
...
#bfrom sklearn.metrics import confusion_matrix as cm
from sklearn.model_selection import train_test_split

data= sns.load_dataset("iris")
data['species'].replace(to_replace=['setosa'], value= 0, inplace=True)
data['species'].replace(to_replace=['versicolor'], value= 1, inplace= True)
data['species'].replace(to_replace=['virginica'], value= 2, inplace= True)
